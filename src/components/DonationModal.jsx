...
//   const { user } = UseAuth();  // ইউজার ইনফরমেশন
//   const stripe = useStripe();
//   const elements = useElements();
...
//     if (!stripe || !elements) {
//       return;  // Stripe বা Elements লোড না হলে কিছু হবে না
//     }

//     const card = elements.getElement(CardElement);

//     if (card == null) {
//       return;  // CardElement পাওয়া না গেলে সাবমিট না করার ব্যবস্থা
//     }

//     // Stripe পেমেন্ট প্রক্রিয়া
//     const { error, paymentMethod } = await stripe.createPaymentMethod({
//       type: 'card',
//       card,
//     });
...
//     } else {
//       console.log('[PaymentMethod]', paymentMethod);
//       // এখানে আপনি paymentMethod প্রসেস করতে পারেন, যেমন server এ পাঠানো
//     }
//   };
...
//       size="sm"
//       open={open}
//       handler={() => setOpen(!open)}  // Modal Toggle
//       className="bg-white shadow"
//     >
//       <Card className="mx-auto w-full shadow-sm rounded-none max-w-[24rem]">
//         <form onSubmit={handleSubmit}>
...
//           </CardBody>
//           <CardFooter className="pt-0">
//             <Button variant="gradient" type="submit" disabled={!stripe} fullWidth>
//               Donate Now
//             </Button>
//           </CardFooter>
//         </form>
