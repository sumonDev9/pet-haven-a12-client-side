                             ...
                             <tr key={headerGroup.id}>
                                 {headerGroup.headers.map((header) => (
                                     <th
                                         ...
                                         className="px-4 py-3 text-sm font-medium tracking-wide cursor-pointer hover:bg-indigo-700"
                             ...
                             >
                                 ...
                                 <td className="px-4 py-3 border-b border-gray-200 text-sm">
                                     {row.original.adopted ? (
                                         <span className="text-green-600 bg-green-50 rounded-lg font-semibold">Adopted</span>
                                     ) : (
